...
/// SEL_BG_RGB #2121FF —— Tau Ceti 计算机蓝，选区唯一底色（无渐变）
pub const SEL_BG: Color = Color::Rgb(0x21, 0x21, 0xff);
/// SEL_FG_SGR #EBEBEB —— 计算机蓝底上的浅字
...
/// DOUBLE_CLICK_MS / DOUBLE_CLICK_DIST (manhattan)
pub const DOUBLE_CLICK_MS: u64 = 400;
pub const DOUBLE_CLICK_DIST: u16 = 3;
/// EDGE_ZONE rows at chat top/bottom
...
pub struct DragState {
    ...
    pub moved: bool,
    pub click_count: u8,
    /// double-click drag snaps end to word edge
    pub word_mode: bool,
...
impl ClickTracker {
    /// now-last < 400ms && manhattan dist < 3 → count+1 (cap 3)
