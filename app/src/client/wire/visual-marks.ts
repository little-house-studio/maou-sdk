...
import type { AgentPresenceStatus } from "./sidebar/agent-tree";
import type { FileIconKind } from "./sidebar/file-tree";
import { fileIconKind } from "./sidebar/file-tree";
...
export function chromeMarkForMode(
  mode: "chat" | "project" | "plugins" | "settings" | "proactive",
): ChromeMarkKind {
  if (mode === "settings") return "settings";
  if (mode === "project") return "mode_project";
  if (mode === "plugins") return "mode_plugins";
