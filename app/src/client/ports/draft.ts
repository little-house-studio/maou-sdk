...
export function createDraftPorts(): AppPorts {
  ...
  return {
    ...
    chat: {
      ...
      searchSessions: reject("chat.searchSessions"),
      ...
      previewDeleteSession: reject("chat.previewDeleteSession"),
      fetchSessionMessages: reject("chat.fetchSessionMessages"),
      loadOlderMessages: reject("chat.loadOlderMessages"),
      ...
      setPermissionPreset: reject("chat.setPermissionPreset"),
      setSessionSendMode: reject("chat.setSessionSendMode"),
      fetchPendingAsk: reject("chat.fetchPendingAsk"),
      answerAsk: reject("chat.answerAsk"),
      forkFromMessage: reject("chat.forkFromMessage"),
      sendMessageFeedback: reject("chat.sendMessageFeedback"),
      fetchSessionPlan: reject("chat.fetchSessionPlan"),
      togglePlan: reject("chat.togglePlan"),
      mutateGoal: reject("chat.mutateGoal"),
    ...
    shell: {
      ...
      fetchTodayUsage: reject("shell.fetchTodayUsage"),
    },
    settings: {
      ...
      setPermissionPreset: reject("settings.setPermissionPreset"),
      setWorkspaceInstructions: reject("settings.setWorkspaceInstructions"),
