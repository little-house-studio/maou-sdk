...
export function createLivePorts(): AppPorts {
  return {
    ...
    chat: {
      ...
      previewDeleteSession: api.previewDeleteSession,
      ...
      setPermissionPreset: api.setPermissionPreset,
      setSessionSendMode: api.setSessionSendMode,
      fetchPendingAsk: api.fetchPendingAsk,
      answerAsk: api.answerAsk,
      forkFromMessage: api.forkFromMessage,
      sendMessageFeedback: api.sendMessageFeedback,
      fetchSessionPlan: api.fetchSessionPlan,
      togglePlan: api.togglePlan,
      mutateGoal: api.mutateGoal,
    ...
    shell: {
      ...
      fetchTodayUsage: api.fetchTodayUsage,
    },
    settings: {
      fetchMeta: api.fetchMeta,
      fetchModels: api.fetchModels,
      setModel: api.setModel,
      setApprovalMode: api.setApprovalMode,
      setPermissionPreset: (id, confirm) => api.setPermissionPreset(id, confirm, "default"),
